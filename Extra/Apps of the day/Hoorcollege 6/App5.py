...
nooit geweest zijn [a]an ' Iedereen op nummer 22, weer is prachti[g], onz[e] kamer is aa[n]gekruisd. Missen jullie.
...
firstsplit= tekst.split("[")
secondsplit = []

for part in firstsplit:
    print(part)
    secondsplit.append(part.split("]"))

i = 1
while i < len(secondsplit):
    letters = secondsplit[i][0]
    if letters != " ":
        print(letters)
    i += 1