...
for i in range(r_in.shape[0]): 
    for j in range(r_in.shape[1]): 
        r_out[i][j] = 0.299 * r_in[i][j] + 0.587 * g_in[i][j] + 0.114 * b_in[i][j]
        g_out[i][j] = 0.299 * r_in[i][j] + 0.587 * g_in[i][j] + 0.114 * b_in[i][j]
        b_out[i][j] = 0.299 * r_in[i][j] + 0.587 * g_in[i][j] + 0.114 * b_in[i][j]
